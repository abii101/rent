      ...
      <table class="table table-bordered table-hover mb-0">
        ...
        <?php
          ...
          $data = mysqli_query($koneksi, "
              SELECT t.kekurangan, t.nik, k.id_kembali, k.id_transaksi, k.tgl_kembali, k.kondisi_mobil, k.denda
              FROM tbl_kembali k
        ...
        ?>
          <tr>
            <td><?php echo $no++ ?></td>
            <td><?php echo $d['nik']; ?></td> <!-- Menampilkan NIK -->
      ...
      <table class="table table-bordered table-hover mb-0">
        ...
        <?php
          ...
          $data = mysqli_query($koneksi, "
              ...
              JOIN tbl_transaksi t ON k.id_transaksi = t.id_transaksi
          "); // Mengambil data NIK dari tbl_transaksi melalui join
...
<script>
  // Ini akan memanggil window.print() ketika tombol Cetak diklik
  function cetak() {
    window.print();
  }
</script>
