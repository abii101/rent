              ...
              <div class="row">
                ...
                <div class="col-md-12 my-4">
                  <div class="card shadow">
                    <div class="card-body">
                      <h5 class="card-title">Ini adalah data dari pengguna Mobilitas.</h5>
                      ...
                      <table class="table table-bordered table-hover mb-0">
                        ...
                        ?>
                          <tr>
                              ...
                              <td><a  href="aksi/useredit.php?nik=<?php echo $d['nik']; ?> " class="btn btn-primary">Edit</a>
                              <a href="aksi/userdelete.php?nik=<?php echo $d['nik']; ?>" class="btn btn-danger">Hapus</a></td>
                          </tr>
                        <?php
                            }
                        ?> 
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="verticalModalTitle">Tambah Member</h5>
