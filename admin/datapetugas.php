...
if (isset($_POST['submit'])) {
    ...
    if (isset($_POST['lvl']) && isset($_POST['user']) && isset($_POST['pass'])) {
        ...
        $sql = "INSERT INTO tbl_user VALUES (null, '$user', '$pass', '$lvl')";
      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="page-title">Data Petugas</h2>
              <div class="row">
                <!-- Bordered table -->
                <div class="col-md-12 my-4">
                  <div class="card shadow">
                    <div class="card-body">
                      <h5 class="card-title">Ini adalah data dari Petugas & Admin Mobilitas.</h5>
                      <button type="button" class="btn mb-4 mt-2 btn-primary" data-toggle="modal" data-target="#verticalModal"> Tambah </button>
                      <table class="table table-bordered table-hover mb-0">
                        ...
                        ?>
                          <tr>
                              ...
                              <td><?php echo $d['lvl']; ?></td>
                              <td><a  href="aksi/useredit.php?id_user=<?php echo $d['id_user']; ?> " class="btn btn-primary">Edit</a>
                              <a href="aksi/userdelete.php?id_user=<?php echo $d['id_user']; ?>" class="btn btn-danger">Hapus</a></td>
                          </tr>
                        <?php
                            }
                        ?> 
                ...
                <div class="modal fade" id="verticalModal" tabindex="-1" role="dialog" aria-labelledby="verticalModalTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="verticalModalTitle">Tambah Operator</h5>
                            ...
                            <div class="form-group mb-3">
                              ...
                              <input type="text" name="user" id="simpleinput" class="form-control">
                            </div>
                            <div class="form-group mb-3">
                        ...
                        <select class="form-control" name="lvl" id="example-select">
