                    ...
                    <div class="card-body">
                      ...
                      <table class="table table-bordered table-hover mb-0">
                        ...
                        <?php
                            include '../koneksi.php';
                            $no = 1;
                          $data = mysqli_query($koneksi, "SELECT * FROM tbl_transaksi   WHERE nik = '$nik' AND status IN ('aprove', 'ambil', 'booking')");
                          ...
                          <tr>
                              ...
                              <td>
                                  <?php if ($d['status'] == 'booking') : ?>
                                      ...
                                      <a href="aksi/kembalikan.php?id_transaksi=<?php echo $d['id_transaksi']; ?>" disabled class="btn btn-secondary w-100">Menunggu Konfirmasi</a>
                                  <?php elseif ($d['status'] == 'aprove') : ?>
                                      <!-- Jika status 'approve', tampilkan tombol Kembalikan -->
                                    <a href="aksi/ambil.php?id_transaksi=<?php echo $d['id_transaksi']; ?>" class="btn btn-primary w-100">Ambil</a>
                                  <?php elseif ($d['status'] == 'ambil') : ?>
                                      <!-- Jika status 'approve', tampilkan tombol Kembalikan -->
                                      <a href="aksi/kembalikan.php?id_transaksi=<?php echo $d['id_transaksi']; ?>"disabled  class="btn btn-warning w-100">Kembalikan sebelum <?php echo $d['tgl_kembali']; ?></a>
                                  <?php endif; ?>
                              </td>
                          </tr>
                        <?php
